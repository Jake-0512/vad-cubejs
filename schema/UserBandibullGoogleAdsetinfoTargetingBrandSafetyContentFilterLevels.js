cube(`UserBandibullGoogleAdsetinfoTargetingBrandSafetyContentFilterLevels`, {
  sql: `SELECT * FROM vad.\`user_bandibull_google_adsetInfo_targeting_brand_safety_content_filter_levels\``,
