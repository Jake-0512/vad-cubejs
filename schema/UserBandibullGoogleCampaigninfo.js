cube(`UserBandibullGoogleCampaigninfo`, {
  sql: `SELECT * FROM vad.\`user_bandibull_google_campaignInfo\``,
  ...
  measures: {
    count: {
      type: `count`,
      drillMembers: [campaigninfoAccountId, campaigninfoCreatedTime, campaigninfoId, campaigninfoName, campaigninfoSourceCampaignId, campaigninfoToplineId, campaigninfoUpdatedTime]
    }
  },
