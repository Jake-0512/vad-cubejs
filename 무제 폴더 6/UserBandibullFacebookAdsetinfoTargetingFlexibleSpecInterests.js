cube(`UserBandibullFacebookAdsetinfoTargetingFlexibleSpecInterests`, {
  sql: `SELECT * FROM vad.\`user_bandibull_facebook_adsetInfo_targeting_flexible_spec_interests\``,
